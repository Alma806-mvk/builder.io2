...
export const TREND_ANALYSIS_SUPPORTED_TYPES = [
    ContentType.TrendAnalysis,
];

export const YOUTUBE_STATS_SUPPORTED_TYPES = [
...
export const IMAGE_GENERATION_SUPPORTED_TYPES = [
...
export const POLL_QUIZ_SUPPORTED_TYPES = [
    ContentType.PollQuiz,
];
